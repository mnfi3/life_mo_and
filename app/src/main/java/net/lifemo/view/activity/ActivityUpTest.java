...
import net.lifemo.system.Utils;
...
public class ActivityUpTest extends AppCompatActivity {
...
//    btnselectpic.setOnClickListener((View.OnClickListener) this);
    //uploadButton.setOnClickListener((View.OnClickListener) this);

    dialog = new ProgressDialog(ActivityUpTest.this);
    ...
    uploadButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, G.MAIN_URL + url, jsonObject,
        ...
        Volley.newRequestQueue(ActivityUpTest.this).add(jsonObjectRequest);
        //break;
      }
    });
